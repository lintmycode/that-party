...
<template>
  <div class="wrapper">
    <template v-if="!uploaded">
      ...
      <div class="form-item">
        <PrimaryButton @click="triggerFileInput" :disabled="!isValidEmail()"
          >Escolher fotos</PrimaryButton
        >
      ...
      <div class="form-item">
        <PrimaryButton @click="uploadFiles" :hidden="files.length === 0" :disabled="loading"
