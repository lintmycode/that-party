...
const loadGMapsScript = () => {
  ...
  script.src = `https://maps.googleapis.com/maps/api/js?key=${import.meta.env.VITE_API_GMAPS}&callback=initMap`;
  script.async = true;
  script.defer = true;
