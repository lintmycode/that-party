...
(4, 'Vinho Tinto (2un)', 3, 0),
(4, 'Espumante (2un)', 3, 0),
(4, 'Gin + Tónica (1un)', 1, 0),
(4, 'Porto + Tónica (1un)', 1, 0),
(4, 'Champarrião (cerveja (1l) + vinho branco (1un) + gasosa (1un))', 2, 0),

(5, 'Água das Pedras (2un)', 2, 1),
(5, 'Coca-cola (2un)', 1, 1),
(5, 'Seven-up (2un)', 1, 1),
(5, 'Ice Tea (2un)', 1, 1),
(5, 'Fanta / Sumol (2un)', 0, 1),
(5, 'Sumos de fruta (2un)', 0, 1);
